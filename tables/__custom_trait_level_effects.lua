trait_level_effects_tables = {
	...
	DATA = {
		...
		{"wh2_main_skill_innate_hef_princess_campaign_3_careful", "wh_main_effect_agent_field_line_of_sight_mod", "character_to_character_own", "12"},
		...
		{"wh2_main_skill_innate_bst_khornes_fury", "wh_dlc08_effect_ability_enable_frenzy", "character_to_character_own", "1"},
		...
		{"wh2_main_skill_innate_grn_serial_danca", "wh_dlc08_effect_ability_enable_frenzy", "character_to_character_own", "1"},
		...
		{"wh2_clc_trait_emp_questionable_excuses", "wh_main_effect_force_all_campaign_replenishment_rate", "character_to_force_own", "7"},
		{"wh2_clc_trait_emp_questionable_excuses", "wh_main_effect_religion_conversion_undeath", "character_to_character_own_provincetext", "1"},
		{"wh2_clc_trait_all_perseverant", "wh_main_effect_character_stat_mod_unit_health", "character_to_character_own", "7"},
		{"wh2_clc_trait_lzd_bloodthirsty", "wh_main_effect_ability_enable_the_hunger", "character_to_character_own", "1"}
	}
}